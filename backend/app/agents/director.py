...
_PROMPT_PATH = Path(__file__).parent.parent.parent.parent / "prompts" / "director.md"


class DirectorAgent(BaseAgent):
    name = "Director"
    role = "Project manager — scopes work, announces room transitions, owns the manifest"
    room_id = "A"
