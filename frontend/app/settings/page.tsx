export default function SettingsPage() {
  return (
    <div style={{ background: '#07090D', minHeight: '100vh', color: '#EAE8F5', fontFamily: 'inherit', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#EAE8F8', margin: 0 }}>Settings</h2>
      <p style={{ fontSize: 13, color: '#5A5870', margin: 0 }}>API key configuration coming soon — Groq, Gemini, Ollama URL</p>
